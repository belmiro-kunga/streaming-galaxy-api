...
export const MovieHero = () => {
  ...
  const handleAssistir = () => {
    navigate('/watch/1'); // Ajuste o ID conforme necessário
  };

  const handleDetalhes = () => {
    navigate('/details/1'); // Ajuste o ID conforme necessário
  };
      ...
      <div className="absolute inset-0 w-full h-full">
        <div className="relative w-full h-full">
          <img
            ...
            alt="Filme de Ação"
            className="absolute top-0 left-0 w-screen h-screen object-cover object-center animate-ken-burns"
            style={{ 
              pointerEvents: 'none'
            }}
          />
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-12 mt-20">
          <div className="max-w-3xl space-y-4 md:space-y-6">
            ...
            <p className="text-sm md:text-base lg:text-lg text-gray-200 max-w-2xl line-clamp-2 md:line-clamp-3 drop-shadow">
              Em um mundo à beira do caos, uma equipe de elite precisa impedir uma ameaça global que pode mudar o curso da história. Com tecnologia de ponta e habilidades extraordinárias, eles enfrentarão seu maior desafio.
            </p>
