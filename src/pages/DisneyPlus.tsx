    ...
    <Layout>
      ...
      <div className="relative h-[60vh] bg-gradient-to-b from-blue-800 to-blue-900">
        ...
        <div className="relative h-full flex items-center justify-center px-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Disney Plus</h1>
            <p className="text-xl text-white/80">O melhor da Disney, Marvel, Star Wars e mais</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <motion.section
          ...
          className="space-y-4"
        >
          <h2 className="text-xl sm:text-2xl font-bold text-white">Em Alta no Disney Plus</h2>
          <MovieCarousel 
            items={[]} 
            type="popular"
          />
