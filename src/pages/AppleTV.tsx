  ...
  return (
    <Layout>
      ...
      <div className="relative h-[60vh] bg-gradient-to-b from-gray-900 to-gray-800">
        ...
        <div className="relative h-full flex items-center justify-center px-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Apple TV+</h1>
            <p className="text-xl text-white/80">Conteúdo original exclusivo</p>
          </div>
        </div>
      </div>
      ...
      <motion.main 
        ...
        className="px-4 md:px-8 -mt-40 space-y-6 bg-gradient-to-b from-gray-900 to-black min-h-screen relative z-10"
      >
        ...
        <motion.section
          ...
          className="space-y-4"
        >
          <h2 className="text-xl sm:text-2xl font-bold text-white">Em Alta no Apple TV+</h2>
          <MovieCarousel 
            items={[]} 
            type="popular"
          />
