...
const HuluPage = () => {
  return (
    <Layout>
      {/* Hero Section */}
      <div className="relative h-[60vh] bg-gradient-to-b from-green-700 to-green-500">
        <div className="absolute inset-0 bg-black/50" />
        <div className="relative h-full flex items-center justify-center px-4">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Hulu</h1>
      ...
      <motion.main 
        ...
        className="px-4 md:px-8 -mt-40 space-y-6 bg-gradient-to-b from-green-700 to-black min-h-screen relative z-10"
      >
        ...
        <motion.section
          ...
          className="space-y-4"
        >
          <h2 className="text-xl sm:text-2xl font-bold text-white">Em Alta no Hulu</h2>
          <MovieCarousel 
            items={[]} 
            type="popular"
          />
